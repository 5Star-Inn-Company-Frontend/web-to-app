...
export function SupportPage() {
    return (
        <>
            <div className="px-6 xl:px-8 py-8 border-b border-primary20 bg-white w-full rounded">
                <h1 className="text-3xl xl:text-4xl font-medium">Support & Updates</h1>
            </div>
            <CollapsibleComponent title="Self-Support for free" subTitle="">
                <div className="border-b border-primary20 pb-4 px-6 xl:px-8">
                    <ul className="text-xs text-[grey] gap-8 list-disc list-inside leading-7">
                        ...
                        <li>
                            Apps function indefinitely subject to future compatibility with iOS and
                            Android versions
                        </li>
                ...
                <div className="grid lg:grid-cols-2 xl:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-4 px-8 py-5">
                    <div className="border border-primary20 p-4 rounded-md flex flex-col justify-between">
                        <div>
                            ...
                            <ul className="text-xs text-[grey] grid gap-y-6 list-disc px-4">
                                <li>
                                    Unlimited online app rebuilds and a guarantee of compatibility
                                    with iOS and Android updates
                                </li>
                                <li>
                                    Priority email support with one business day or sooner response
                                    from our team
                                </li>
                                <li>
                                    Engineering support for web to app integrationss and advanced
                                    troubleshooting
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="border border-primary20 py-4 rounded-md">
                        <div className="px-4 pb-4 border-b border-primary40">
                            ...
                            <ul className="text-xs text-[grey] grid gap-y-6 list-disc px-4">
                                <li>
                                    Technical support for MDM deploymens, private app stores, app
                                    security assessments
                                </li>
                                <li>
                                    Phone-based incidents reporting for business hours or 24-hour
                                    coverage
                                </li>
                                <li>
                                    SLA to provide certainty of ongoing compatibility and response
                                    yarget times
                                </li>
                            </ul>
                        </div>
