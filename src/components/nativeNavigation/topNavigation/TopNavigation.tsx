...
import TopNavigationCollapsable from "@/features/nativenavigation/TopNavigationCollapsable";
        ...
        <div>
            <TopNavigationCollapsable title="Display Mode">
                <p className="text-sm text-primary60">
                    A native Top Navigation Bar can be used to helo your users navigate throughout your app. You can
                    display dynamic titles depending on the page being shown. You may also add a search bar form,
                    refresh functionality, and custom buttons. When a Sidebar Navigation Menu is also enabled, a
                    "hamburger" toggle button is shown in the top nav bar to easily open the menu.
                </p>
                <div>
            ...
            <TopNavigationCollapsable title="Styling">
                <p className="text-sm text-primary60 mb-6">
                    ...
                    image. To show different content based on the page being shown in your app, configure Dynamic
                    Titles. Note hat for iOS the color of any native UI elements such as the hamburger menu will follow
                    the app-wide Theme colors set on the Branding tab.
                </p>
