...
import { IAppDataResponse } from "@/types/type";

export const OverviewSection = () => {
    const data: IAppDataResponse = useOutletContext();
            ...
            <div className="flex gap-1 flex-col">
                ...
                <div className="px-8 bg-white pb-5">
                    <CollapsibleComponent title="Website Url" subTitle="The website to display when you loads">
                        <Input type="text" className="p-2 w-[90%] mx-auto bg-white border" value={data?.data.url} />
                ...
                <div className="px-8 pb-5 bg-white border-t border-primary20">
                    <CollapsibleComponent title="App Name" subTitle="Your name is displayed on the device homescreen">
                        <Input type="text" className="border w-[90%] mx-auto p-2" value={data?.data.name} />
                    </CollapsibleComponent>
                </div>
                <div className="px-8 pb-5 bg-white border-t border-primary20">
                    <CollapsibleComponent
                    ...
                    >
                        <div className="px-8">
                            <textarea
                                className="border border-primary20 w-full px-4 py-2 rounded-lg focus:outline-none"
