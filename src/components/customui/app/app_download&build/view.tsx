                        ...
                        <div className="grid grid-cols-2 gap-x-16">
                            ...
                            >
                                <div className="flex flex-col gap-y-2 py-4 px-3">
                                    <Label htmlFor="bundle_id" className="text-[0.625rem] font-normal text-primary40">IOS BUNDLE ID</Label>
                                    <Input type="text" className="h-8 w-full border-none rounded-lg text-[0.625rem] px-2 bg-primary20 text-primary60" value="co.5star.iso.qjijre" />
                                </div>
                            </OsConfigCard>
                            <OsConfigCard os="Android">
                                <div className="flex flex-col gap-y-2 py-3 px-3">
                                    <Label htmlFor="bundle_android_name" className="text-[0.625rem] font-normal text-primary40">
                                        ANDROID BUNDLE NAME
                                    </Label>
                                    <Input type="text" className="h-8 w-full border-none rounded-lg text-[0.625rem] px-2 bg-primary20 text-primary60" value="co.5star.iso.qjijre" />
                                </div>
                                <div className="flex flex-col gap-y-2  px-3">
                                    <Label htmlFor="bundle_andriod_version" className="text-[0.625rem] font-normal text-primary40">
                                        ANDROID VERSION NAME
                                    </Label>
                                    <Input type="text" className="h-8 w-full rounded-lg text-[0.625rem] px-2 border border-primary40 text-primary60" value="1.0.0" />
                                </div>
                            </OsConfigCard>
                        </div>
                    </CollapsibleComponent>
                        ...
                        <div>
                            ...
                            <RadioGroup
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <Label htmlFor="disable" className="text-xs">Disable</Label>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <RadioGroupItem value="enable" id="r2" />
                                    <Label htmlFor="enable" className="text-xs">Enable</Label>
                                </div>
                            </RadioGroup>
                        </div>
                    </CollapsibleComponent>
                    ...
                    >
                        <div className="flex flex-col gap-4 mb-10">
                            <div className="flex flex-col gap-2 w-fit">
                                <Label htmlFor="airplane-mode" className="text-[grey] text-[0.625rem]">EDIT APPCONFIG.JSON</Label>
                            ...
                            <div className="flex flex-col gap-2 w-fit">
                                <Label htmlFor="airplane-mode" className="text-[grey] text-[0.625rem]">UPLOAD APPCONFIG.JSON</Label>
                                <Button className="flex items-center gap-x-4 bg-white border text-black text-[0.875rem] w-[8.9375rem]">
                                    <GoUpload size="1rem" />
                                    Upload
                                </Button>
                            ...
                            <div className="flex flex-col gap-2 w-fit">
                                <Label htmlFor="airplane-mode" className="text-[grey] text-[0.625rem]">EXPORT APPCONFIG.JSON</Label>
                                <Button className="flex items-center gap-x-4 bg-white border text-black text-[0.875rem] w-[8.9375rem]">
                            ...
                            <div className="flex flex-col gap-2 w-fit">
                                <Label htmlFor="airplane-mode" className="text-[grey] text-[0.625rem]">IMPORT FROM EXISTING APP</Label>
                                <Button className="flex items-center gap-x-4 bg-white border text-black text-[0.875rem] w-[8.9375rem]">
