...
export const AppPermissionSection = () => {
    return (
        <>
            ...
            <div className="px-10 py-4 bg-white border-b border-primary20">
                ...
                >
                    <Button className="flex items-center gap-2 bg-white border text-black hover:text-white">
            ...
            <div className="px-10 py-4 bg-white mb-10">
                <CollapsibleComponent
