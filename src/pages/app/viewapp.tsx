                ...
                <div className="w-[75%] mx-4 rounded-lg">
                    <div className="my-12">
                        ...
                        <div className="flex items-center justify-center gap-x-10">
                            <button className="flex items-center gap-x-5 text-xs bg-black text-white rounded-lg px-5 h-8  w-[14.1875rem]" onClick={() => navigate("/app/edit/overview")}><i className="fa-solid fa-pen-to-square"></i>  Edit App</button>
                            <button className="flex items-center gap-x-5 text-xs bg-primary20 rounded-lg px-5 h-8  w-[14.1875rem]"><img src="/backup-icon.png" alt="" />  Manage App Backups</button>
                            <button className="flex items-center gap-x-5 text-xs bg-primary20 rounded-lg px-5 h-8  w-[14.1875rem]"><i className="fa-solid fa-copy"></i>  Cone App on 5star</button>
                        </div>
                    </div>
