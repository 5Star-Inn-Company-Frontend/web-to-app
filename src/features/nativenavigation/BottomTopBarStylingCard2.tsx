...
interface IBottomTopBarStylingCard2 {
    os: "IOS" | "Android";
}
export const BottomTopBarStylingCard2 = ({ os }: IBottomTopBarStylingCard2) => {
    return (
        <div className="rounded-md border border-primary20">
            ...
            <div className="px-6 py-4">
                <Text style="text-md mb-4" value="Tab Bar Text" />
            ...
            <div className="px-6 py-4">
                <Text style="text-md mb-4" value="Tab Bar Indicator" />
                <div className="flex gap-4 items-center text-primary40 w-[60%]">
                    <div className="w-full">
                        <div className="flex gap-2 items-center text-xs mb-4">
                            <CiLight />
