...
export const PluginCard = ({img, title}: PluginCardProps) => {
        ...
        <Collapsible className="mb-2 border border-primary5 p-4 rounded-lg" open={isOpen}>
            <CollapsibleTrigger className="w-full" onClick={() => setIsOpen(!isOpen)}>
                <div className="flex items-center gap-x-2 justify-between">
                    ...
                    <div className="flex items-center gap-x-2">
                        <h4 className="text-sm font-bold">#2000</h4>
                        ...
                        <Button className="w-[3.25rem] h-[1.0625rem] font-medium text-xs rounded-lg">Add</Button>
