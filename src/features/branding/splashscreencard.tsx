...
export const SplashScreenCard = ({ os, img }: ISplashScreenCard) => {
        ...
        <div className="rounded-md border border-primary20">
            ...
            <div className="flex gap-4 flex-col px-6">
                ...
                <div className="flex flex-wrap justify-between items-center gap-4">
                    ...
                    <Button className="bg-white border text-black hover:bg-black hover:text-white outline-none">
                        Match {os}
                    </Button>
                </div>
                        ...
                        <div>
                            ...
                            <div className="w-fit flex justify-between border rounded-md px-2 py-1 items-center gap-2">
                                <ColorPicker
                                    ...
                                    setBackground={(color) => setScreenBackground(color)}
                                />
                            </div>
                        </div>
                    </div>
