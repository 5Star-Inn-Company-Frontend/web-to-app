    ...
    return (
        <div className="pt-2 pb-5 xl:px-6 xl:py-4 bg-white border-b border-primary20">
            <CollapsibleComponent
                ...
                subTitle="Background audio permission on iOS allows audio from the app to be played while the app is minimized or backgrounded. Use the JavaScript Bridge to start and stop the background audio service to make use of this feature."
            >
